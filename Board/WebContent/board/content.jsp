...
onclick="document.location.href='/JunJSP/day0718/mvc2/updateForm.do?num=${article.num}&pageNum=${pageNum}'">
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="글삭제"
onclick="document.location.href='/JunJSP/day0718/mvc2/deleteForm.do?num=${article.num}&pageNum=${pageNum}'">
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="답글쓰기"
onclick="document.location.href='/JunJSP/day0718/mvc2/writeForm.do?num=${article.num}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}'">
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="글목록"
onclick="document.location.href='/JunJSP/day0718/mvc2/list.do?pageNum=${pageNum}'">
</td>
</tr>
</table>   
</form>     
